...
public class MemberView {
	...
	MemberController mController; 	// View 클래스에서 계속 쓸거니 필드로 둔다.
		...
		while(true) {
			...
			switch(value) {
				...
				case 4 :
					...
					// memberId전달해야되니까 printOneMember(memberId);
					...
					if(member != null) {
						...
						// UPDATE를 할 때에는 가장 중요한 것이 WHERE 조건절이니까, WHERE에 들어갈 데이터를 전달해줘야 함.
				...
				case 5:
					...
					// 사용자가 삭제할 아이디 입력받아야 되니까 printOneMember()
	...
	private String inputMemberId() {
		...
		// 호출한 곳에서 써야되니까 return memberId, MemberView:38
		return memberId;
	}
	// MemberView:36
	...
	public int printMainMenu() {
		...
		return choice; // 다른메소드에서 쓸 수 있도록 리턴
	}
}
