...
public class MemberController {
	...
	public int modifyMember(Member modifyInfo) {
		...
		// memberId 전달해야되니까 updateMember(modifyInfo)
		int result = mDao.updateMember(modifyInfo);
		// 호출한 곳에서 써야되니까 return result
		return result;
	}
	...
	public int removeMember(String memberId) {
		...
		// 호출한 곳에서 써야되니까 return result, MemberView:52
		return result;
	}
	...
	public Member printOneMember(String memberId) {
		...
		// 호출한 곳에서 써야되니까 return member, MemberView:41
		return member;
	}
}
